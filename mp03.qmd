...
This interactive map further explores the spatial distribution of NYC's trees. The visualization uses marker clustering to handle the large dataset efficiently. At lower zoom levels, nearby trees are grouped into clusters, which break apart as you zoom in. Each tree is color-coded by condition (green = good, yellow = fair, orange = poor, red = dead). Users can also clicking on individual trees to see additional details about the species, condition, and location.
